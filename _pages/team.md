...
<div class="row mb-5">
  ...
  <div class="col-sm-9">
    <h4 class="mt-2">Aman Kumar <span style="font-size: 0.7em; color: gray;">— Lead ML Systems Engineer</span></h4>
    <p style="margin-bottom: 5px;"><strong>Focus:</strong> Pipeline Optimization, Conformal Prediction, Applied Frameworks.<br>
...
<div class="row mb-5">
  ...
  <div class="col-sm-9">
    <h4 class="mt-2">Dishant Das <span style="font-size: 0.7em; color: gray;">— Research Scientist</span></h4>
...
<div class="row mb-5">
  ...
  <div class="col-sm-9">
    ...
    <p>Engineers applied computer vision frameworks, Space AI and other frameworks for remote sensing and extreme environments. Drives targeted, impactful research cycles—specifically contributing to fuzzy rule extraction and interpretable defect detection architectures for solar and satellite networks.</p>
  </div>
</div>
